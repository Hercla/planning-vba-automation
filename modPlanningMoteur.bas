...
Sub RemplacementPlanning_FullDynamiqueUltraOptimisee(ws As Worksheet, colDeb As Long)
    ...
    For col = 1 To nbJours
        ...
        End If
        isFerie = ModuleUtils.IsJourFerieOuRecup(CStr(ferieArr(1, col)))
                            ...
                            For iCode = LBound(regle.CodesCandidats) To UBound(regle.CodesCandidats)
                                ...
                                If Not IsEmpty(groupeExclu) Then
                                    ...
                                    For Each excluCode In groupeExclu
                                        If ModuleUtils.CodeDejaPresent(planningArr, rempJourArr, col, excluCode, True) Then
                                            excluPresent = True: Exit For
                                        End If
                                    Next excluCode
                                    If excluPresent Then GoTo NextCodeCand_Jour
                                End If
                                If Not ModuleUtils.CodeDejaPresent(planningArr, rempJourArr, col, codeCand, True) Then
...
NextCodeCand_Jour:
        ...
        Next slotLigne
                            ...
                            If Not ModuleUtils.CodeDejaPresent(planningArr, rempNuitArr, col, codeCand, True) Then
