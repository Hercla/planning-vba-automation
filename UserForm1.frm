...
Attribute VB_Base = "0{57676C4B-58F8-4282-8C12-3180AEBFE77D}{F8928066-7C22-41E5-8BFE-B123AEC5C276}"
...
' Vérifier si la cellule active se trouve dans la plage de "planning" de l'onglet actif
    ...
    ActiveCell = Sheets("Config_Calendrier").Range("W13").value
...
' Vérifier si la cellule active se trouve dans la plage de "planning" de l'onglet actif
    ...
    ' Écrire la valeur de la cellule W2 de l'onglet "Acceuil" dans la cellule active
    ActiveCell = Sheets("Config_Calendrier").Range("W29").value
...
' Vérifier si la cellule active se trouve dans la plage de "planning" de l'onglet actif
    ...
    ' Écrire la valeur de la cellule W2 de l'onglet "Acceuil" dans la cellule active
    ActiveCell = Sheets("Config_Calendrier").Range("W34").value
...
Private Sub CommandButton75_Click()
    ...
    With ActiveCell
        .value = Sheets("Config_Calendrier").Range("W32").value
